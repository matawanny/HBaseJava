...
do
        ...
        then
          ...
          if [[ $? -eq 0 ]]
          then
          	echo "sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyInitializeProcess.sh $as_of_date"
          	sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyInitializeProcess.sh $as_of_date
          	echo "sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyBatchProcess.sh $as_of_date"
          	sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyBatchProcess.sh $as_of_date
			  ...
			  then
			     ...
			     echo "sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/DailyBatchProcess.sh $day1Int UpdateHbaseOnly"
			     sh -x /usr/book/app/yb-apache-hbase/src/main/scripts/fhlmc/DailyBatchProcess.sh $day1Int UpdateHbaseOnly
			  fi
