...
NVL(prefix, '') as prefix, NVL(ins_cancel_ind, '') as ins_cancel_ind, NVL(govt_ins_grnte, '') as govt_ins_grnte, NVL(assumability_ind, '') as assumability_ind, NVL(prepay_term, '') as prepay_term  
