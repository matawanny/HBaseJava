...
public class FhlmcMonthlyFileParser extends BaseFileParser {
	...
	public FhlmcMonthlyFileParser(String inputFileName) {
		super();
		...
		try {
			...
			armLoanPen = new CSVWriter(new FileWriter("fhlmc_arm_loan_monthly.csv", true),
					'|', CSVWriter.NO_QUOTE_CHARACTER,
					CSVWriter.DEFAULT_ESCAPE_CHARACTER,
					CSVWriter.DEFAULT_LINE_END);
			modLoanPen = new CSVWriter(new FileWriter("fhlmc_mod_loan_monthly.csv", true),
					'|', CSVWriter.NO_QUOTE_CHARACTER,
					CSVWriter.DEFAULT_ESCAPE_CHARACTER,
					CSVWriter.DEFAULT_LINE_END);			
		} catch (IOException e) {
