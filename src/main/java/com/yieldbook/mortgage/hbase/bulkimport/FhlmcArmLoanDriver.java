 ...
 * </ol>
 */
public class FhlmcArmLoanDriver {
...
*/
		...
		// Create the job
		Job job = new Job(conf, "FHLMC Arm Loan Monthly Bulk Load");

		job.setJarByClass(FhlmcArmLoanMapper.class);
		job.setMapperClass(FhlmcArmLoanMapper.class);
