...
*/
		...
		// Create the job
		Job job = new Job(conf, "FHLMC Loan Monthly Bulk Load");

		job.setJarByClass(FhlmcLoanMapper.class);
		job.setMapperClass(FhlmcLoanMapper.class);
