...
public class FhlmcLoanInitialize {

	final static String FHLMC_LOAN="fhlmc_loan_monthly";
	final static String FHLMC_ARM_LOAN="fhlmc_arm_loan_monthly";
	final static String FHLMC_MOD_LOAN="fhlmc_mod_loan_monthly";
    ...
    public static void main(String[] args) throws IOException {
        ...
        tables[0]=FHLMC_LOAN;
        tables[1]=FHLMC_ARM_LOAN;
        tables[2]=FHLMC_MOD_LOAN;
